  ...
  <div class="content-viewer">
    ...
    <section class="content-container-section-1">
      ...
      <div id="content-container-1">
        <h1 style="border-bottom: 1.75rem solid var(--body-span-line-syapole); text-anchor: end;" class="subtitle">{{ $t("bodyContent.memberConclusion") }}</h1>
          <p>
            <br>{{ $t("bodyContent.introFirstLineConclusion") }}
            <br>{{ $t("bodyContent.introSecondLineConclusion") }}
            <br>
            <br><v-avatar
              tile
              size="3rem">
...
export default {
  name: "bodyContentViewerConclusion",
  data: () => ({
    isSmallScreen: false,
  }),
}
...
#line-cross-in-L-1{
  ...
  border-right: 1.375rem solid var(--body-span-line-chikai);
  border-top: 1.375rem solid var(--body-span-line-chikai);
  transform: translate(-3.625rem, 3rem);
}
...
#content-container-line-1 {
  ...
  height: 100%;
  width: 1.375rem;
  background-image: linear-gradient(to bottom, var(--body-span-line-chikai), var(--body-span-line-pyutocor));
  transform: translate(1.375rem, 8rem);
}
...
#line-cross-out-L-1{
  ...
  transform: translate(2.765rem, 40rem); /*Section 1 Original Calc Point*/
}
