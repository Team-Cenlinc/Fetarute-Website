...
export const communityMessages: Readonly<Record<Locale, CommunityMessages>> = {
  ...
  en: {
    ...
    mapLabel: "Community neighbourhood map",
    mosaicInvitation: "The grey squares leave room for you to join us.",
    mapHint:
      "Every plot is a neighbour to get to know. Hover over a plot, focus it with your keyboard, or tap to meet the people and communities here.",
    player: "Player",
    playerRoles: {
      owner: "Server owner",
    ...
    groupPlaceholder: "Fellow travellers we’ve yet to meet",
    ...
    mottoPending: "This neighbour has not shared a personal note yet.",
    ...
    partnerProfiles: {
      ...
      hydcraft: {
        description:
          "From putting up buildings and laying track to creating entire cities, the people of HydCraft weave railways, neighbourhoods and everyday player life into a shared map. In a world where creative building meets modded play, they make plenty of room to build together. Fetarute has stood alongside them since 2018.",
      ...
      nebulaecraft: {
        description:
          "At NebulaeCraft, cities and rail transit form the backbone of the world. Lines run through neighbourhoods, stations tie the city together, and the map preserves memories of journeys across successive worlds.",
